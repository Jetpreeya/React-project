    ...
    return (
      <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 shadow-sm">
        <div class="container-fluid">
          <a class="navbar-brand" href="http://localhost:3000/home">Home</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="http://localhost:3000/product"><i class='fa fa-tag fa-2x'></i>
                    Product</a>
              </li>
            </ul>
            </div>
            ...
            <div className="buttons">
                <a href="http://localhost:3000/home" className="btn btn-outline-dark ms-2">
